...
function Footer() {
  return (
    <div data-scroll data-section data-scroll-speed="-.003" className='w-full flex h-screen bg-zinc-900 p-20'>
        <div className='w-1/2 h-full flex flex-col justify-between font-["Founders_Grotesk_X-Condensed"]'>
            <div className='heading'>
                <h1 className='text-[7rem] font-semibold uppercase leading-none tracking-tighter'>EYE-</h1>
                <h1 className='text-[7rem] font-semibold uppercase leading-none tracking-tighter'>OPENING</h1>
            </div>
            <h3>
        ...
        <div className='w-1/2 h-full font-["Founders_Grotesk_X-Condensed"]'>
            <div className='heading mb-20'>
                <h1 className='text-[5rem] font-semibold uppercase leading-none -mb-10 tracking-tighter'>PRESENTATIONS</h1>
            </div>

            <div>
            <h3 className='mb-5'>S:</h3>
                {["Instagram", "Behance", "Linkedin", "Facebook"].map((item, index) => (
                    <a key={index} className='block'>{item}</a>
                ))}
            </div>
            ...
            <div className='mt-10 flex '>
                ...
                <div className='w-3/4'>
                    <h3 className='mb-5 flex'>L:</h3>
                        {["202-1965 W 4th Ave", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"].map((item, index) => (
                            <a key={index} className={`block font-semibold ${index === 1 ? "mb-5" : ""}`}>{item}</a>
                        ))}
                </div>
                <div className=' row-start-1 row-end-4'>
                    <h3 className='mb-5 flex'>M:</h3>
            ...
            <div className='font-semibold mt-5'>
                    <h3 className='mb-5 flex'>E:</h3>
                       <a>hello@ochi.design</a>
            </div>

            <div className='font-semibold mt-[4rem] flex gap-x-72 opacity-[.67] text-lg'>
                <h3 className='flex'>© ochi design 2024. Legal Terms</h3>
